...
import org.acme.travels.FlightBookingModelOutput;
...
public class FlightBookingResource {
    ...
    Process<FlightBookingModel> process;
    ...
    public List<FlightBookingModelOutput> getResources_flightBooking() {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public FlightBookingModelOutput getResource_flightBooking(@PathParam("id") String id) {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public FlightBookingModelOutput deleteResource_flightBooking(@PathParam("id") final String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public FlightBookingModelOutput updateModel_flightBooking(@PathParam("id") String id, FlightBookingModel resource) {
    ...
    @Path("/{id}/tasks")
    @Produces(MediaType.APPLICATION_JSON)
    public List<WorkItem> getTasks_flightBooking(@PathParam("id") String id, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
