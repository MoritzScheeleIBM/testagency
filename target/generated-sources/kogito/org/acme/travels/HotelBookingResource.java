...
import org.acme.travels.HotelBookingModelOutput;
...
public class HotelBookingResource {
    ...
    Process<HotelBookingModel> process;
    ...
    public List<HotelBookingModelOutput> getResources_hotelBooking() {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public HotelBookingModelOutput getResource_hotelBooking(@PathParam("id") String id) {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public HotelBookingModelOutput deleteResource_hotelBooking(@PathParam("id") final String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public HotelBookingModelOutput updateModel_hotelBooking(@PathParam("id") String id, HotelBookingModel resource) {
    ...
    @Path("/{id}/tasks")
    @Produces(MediaType.APPLICATION_JSON)
    public List<WorkItem> getTasks_hotelBooking(@PathParam("id") String id, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
