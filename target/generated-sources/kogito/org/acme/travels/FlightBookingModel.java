...
public class FlightBookingModel implements org.kie.kogito.Model {
    ...
    public FlightBookingModelOutput toOutput() {
        FlightBookingModelOutput result = new FlightBookingModelOutput();
        result.setId(getId());
