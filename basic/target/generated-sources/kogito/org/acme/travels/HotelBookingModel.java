...
public class HotelBookingModel implements org.kie.kogito.Model {
    ...
    public HotelBookingModelOutput toOutput() {
        HotelBookingModelOutput result = new HotelBookingModelOutput();
        result.setId(getId());
